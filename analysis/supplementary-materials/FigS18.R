...
dir.create(here("analysis","supplementary-materials","FigS18"))
...
pdf(here("analysis","supplementary-materials","FigS18","FigS18-a.pdf"), width=3, height=2)
E_11_08_spider
dev.off()
...
pdf(here("analysis","supplementary-materials","FigS18","FigS18-b.pdf"), width=3, height=2)
T_12_06_spider
dev.off()
...
pdf(here("analysis","supplementary-materials","FigS18","FigS18-c.pdf"), width=3, height=2)
T_12_07_spider
dev.off()
...
pdf(here("analysis","supplementary-materials","FigS18","FigS18-d.pdf"), width=3, height=2)
T_12_08_spider
dev.off()
...
pdf(here("analysis","supplementary-materials","FigS18","FigS18-e.pdf"), width=3, height=2)
T_12_09_spider
dev.off()
...
pdf(here("analysis","supplementary-materials","FigS18","FigS18-f.pdf"), width=3, height=2)
T_12_10_spider
dev.off()
...
#### plot ####
d_spider <- OIB %>%
  dplyr::filter(Sample %in% c("34227","120903-KOS 13-4","34224")) %>%
  mutate(Location = case_when(
    grepl("34227", Sample) ~ "[34227] Kosrae (Caroline)",
    grepl("120903-KOS 13-4", Sample) ~ "[KOS_13-4] Kosrae (Caroline)",
    grepl("34224", Sample) ~ "[34224] Kosrae (Caroline)")) %>%
  dplyr::select(Sample,Location,lat,long,Cs,Rb,Ba,Th,U,Nb,Ta,La,Ce,Pr,
                Nd,Sr,Sm,Zr,Ti,Eu,Gd,Tb,Dy,Y,Er,Yb,Lu) %>%
  normalize_to_pm()
...
shapes <- c("[34227] Kosrae (Caroline)"=0,
            "[KOS_13-4] Kosrae (Caroline)"=1,
            "[34224] Kosrae (Caroline)"=2,
            "K-12-24"=12)
cols <- c("[34227] Kosrae (Caroline)"="#320A5A",
          "[KOS_13-4] Kosrae (Caroline)"="#320A5A",
          "[34224] Kosrae (Caroline)"="#320A5A",
          "K-12-24"="red")
...
pdf(here("analysis","supplementary-materials","FigS18","FigS18-g.pdf"), width=3, height=2)
K_12_24_spider
dev.off()
...
dist <- data.frame(
  Sample = c(d_pca[1:62,"Sample"]),
  Location = c(d_pca[1:62,"Location"]),
  PC1 = c(sqrt(((d_pca[63,"PC1"])-d_pca[1:62,"PC1"])^2)),
  PC2 = c(sqrt(((d_pca[63,"PC2"])-d_pca[1:62,"PC2"])^2)),
  PC3 = c(sqrt(((d_pca[63,"PC3"])-d_pca[1:62,"PC3"])^2)),
  PC4 = c(sqrt(((d_pca[63,"PC4"])-d_pca[1:62,"PC4"])^2)),
  PC5 = c(sqrt(((d_pca[63,"PC5"])-d_pca[1:62,"PC5"])^2)),
  PC6 = c(sqrt(((d_pca[63,"PC6"])-d_pca[1:62,"PC6"])^2)),
  PC7 = c(sqrt(((d_pca[63,"PC7"])-d_pca[1:62,"PC7"])^2))) %>%
  mutate(weight_mean = (
    (PC1*eig[1,2])+(PC2*eig[2,2])+(PC3*eig[3,2])+(PC4*eig[4,2])+(PC5*eig[5,2])+
      (PC6*eig[6,2])+(PC7*eig[7,2])) / (sum(eig[1:7,2])))
...
#### plot ####
d_spider <- OIB %>%
  dplyr::filter(Sample %in% c("143076","143077","143075","143078")) %>%
  mutate(Location = case_when(
    grepl("143076", Sample) ~ "[143076] Kosrae (Caroline)",
    grepl("143077", Sample) ~ "[143077] Kosrae (Caroline)",
    grepl("143075", Sample) ~ "[143075] Kosrae (Caroline)",
    grepl("143078", Sample) ~ "[143078] Kosrae (Caroline)")) %>%
  dplyr::select(Sample,Location,lat,long,Cs,Rb,Ba,Th,U,Nb,Ta,La,Ce,Pr,
                Nd,Sr,Sm,Zr,Ti,Eu,Gd,Tb,Dy,Y,Er,Yb,Lu) %>%
  normalize_to_pm()
...
shapes <- c("[143076] Kosrae (Caroline)"=0,
            "[143077] Kosrae (Caroline)"=1,
            "[143075] Kosrae (Caroline)"=2,
            "[143078] Kosrae (Caroline)"=5,
            "K-12-25"=13)
cols <- c("[143076] Kosrae (Caroline)"="#320A5A",
          "[143077] Kosrae (Caroline)"="#320A5A",
          "[143075] Kosrae (Caroline)"="#320A5A",
          "[143078] Kosrae (Caroline)"="#320A5A",
          "K-12-25"="red")
...
pdf(here("analysis","supplementary-materials","FigS18","FigS18-h.pdf"), width=3, height=2)
K_12_25_spider
dev.off()
...
dist <- data.frame(
  Sample = c(d_pca[1:53,"Sample"]),
  Location = c(d_pca[1:53,"Location"]),
  PC1 = c(sqrt(((d_pca[54,"PC1"])-d_pca[1:53,"PC1"])^2)),
  PC2 = c(sqrt(((d_pca[54,"PC2"])-d_pca[1:53,"PC2"])^2)),
  PC3 = c(sqrt(((d_pca[54,"PC3"])-d_pca[1:53,"PC3"])^2)),
  PC4 = c(sqrt(((d_pca[54,"PC4"])-d_pca[1:53,"PC4"])^2)),
  PC5 = c(sqrt(((d_pca[54,"PC5"])-d_pca[1:53,"PC5"])^2)),
  PC6 = c(sqrt(((d_pca[54,"PC6"])-d_pca[1:53,"PC6"])^2)),
  PC7 = c(sqrt(((d_pca[54,"PC7"])-d_pca[1:53,"PC7"])^2))) %>%
  mutate(weight_mean = (
    (PC1*eig[1,2])+(PC2*eig[2,2])+(PC3*eig[3,2])+(PC4*eig[4,2])+(PC5*eig[5,2])+
      (PC6*eig[6,2])+(PC7*eig[7,2])) / (sum(eig[1:7,2])))
...
#### plot ####
d_spider <- OIB %>%
  dplyr::filter(Sample %in% c("1867328","1867325","1867326","1867363")) %>%
  mutate(Location = case_when(
    grepl("1867328", Sample) ~ "[1867328] Ponape (Caroline)",
    grepl("1867325", Sample) ~ "[1867325] Ponape (Caroline)",
    grepl("1867326", Sample) ~ "[1867326] Ponape (Caroline)",
    grepl("1867363", Sample) ~ "[1867363] Ponape (Caroline)")) %>%
  dplyr::select(Sample,Location,lat,long,Cs,Rb,Ba,Th,U,Nb,Ta,La,Ce,Pr,
                Nd,Sr,Sm,Zr,Ti,Eu,Gd,Tb,Dy,Y,Er,Yb,Lu) %>%
  normalize_to_pm()
d_spider[d_spider == 0] <- NA # Replace 0 with NA
...
shapes <- c("[1867328] Ponape (Caroline)"=0,
            "[1867325] Ponape (Caroline)"=1,
            "[1867326] Ponape (Caroline)"=2,
            "[1867363] Ponape (Caroline)"=5,
            "K-12-26"=14)
cols <- c("[1867328] Ponape (Caroline)"="#320A5A",
          "[1867325] Ponape (Caroline)"="#320A5A",
          "[1867326] Ponape (Caroline)"="#320A5A",
          "[1867363] Ponape (Caroline)"="#320A5A",
          "K-12-26"="red")
...
pdf(here("analysis","supplementary-materials","FigS18","FigS18-i.pdf"), width=3, height=2)
K_12_26_spider
dev.off()
