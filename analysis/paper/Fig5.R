...
dir.create(here("analysis","figures","Figure_5"))
...
pdf(here("analysis","figures","Figure_5","Fig5-a.pdf"), width=3, height=2)
E_11_03_spider
dev.off()
...
pdf(here("analysis","figures","Figure_5","Fig5-c.pdf"), width=3, height=2)
K_12_28_spider
dev.off()
...
pdf(here("analysis","figures","Figure_5","Fig5-d.pdf"), width=3, height=2)
K_12_29_spider
dev.off()
