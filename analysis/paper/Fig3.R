...
pdf(here("analysis","figures","Figure_3","Fig3-a.pdf"), width=6, height=3.5)
E_11_03_PCA_1b | PCs
dev.off()
...
PC1 <- ggplot(d_pca, aes(x = PC1, y = 0)) +
  geom_density_ridges(aes(color=Location, fill=Location), alpha=0.4, size=.25) +
  annotate("segment", x=d_pca[38,"PC1"], xend=d_pca[38,"PC1"],
           y=0, yend=Inf, col="red", size=.75) + # E-11-03
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  theme_void() + theme(
...
PC2 <- ggplot(d_pca, aes(x = PC2, y = 0)) +
  geom_density_ridges(aes(color=Location, fill=Location), alpha=0.4, size=.25) +
  annotate("segment", x=d_pca[38,"PC2"], xend=d_pca[38,"PC2"],
           y=0, yend=Inf, col="red", size=.75) + # E-11-03
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  theme_void() + theme(
...
PC3 <- ggplot(d_pca, aes(x = PC3, y = 0)) +
  geom_density_ridges(aes(color=Location, fill=Location), alpha=0.4, size=.25) +
  annotate("segment", x=d_pca[38,"PC3"], xend=d_pca[38,"PC3"],
           y=0, yend=Inf, col="red", size=.75) + # E-11-03
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  theme_void() + theme(
...
PC4 <- ggplot(d_pca, aes(x = PC4, y = 0)) +
  geom_density_ridges(aes(color=Location, fill=Location), alpha=0.4, size=.25) +
  annotate("segment", x=d_pca[38,"PC4"], xend=d_pca[38,"PC4"],
           y=0, yend=Inf, col="red", size=.75) + # E-11-03
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  theme_void() + theme(
...
pdf(here("analysis","figures","Figure_3","Fig3-b.pdf"), width=6, height=3.5)
E_11_03_PCA_2b | PCs
dev.off()
...
PC1 <- ggplot(d_pca, aes(x = PC1, y = 0)) +
  ...
  annotate("segment", x=d_pca[154:155,"PC1"], xend=d_pca[154:155,"PC1"],
           y=0, yend=Inf, col="red", size=.75) + #E_11_06 & E_11_07
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  theme_void() + theme(
    axis.text.x=element_text(size=6), axis.title.x=element_text(size=6),
...
pdf(here("analysis","figures","Figure_3","Fig3-c.pdf"), width=6, height=3.5)
E_11_06_PCA_1b | PCs
dev.off()
...
PC1 <- ggplot(d_pca, aes(x = PC1, y = 0)) +
  geom_density_ridges(aes(color=Location, fill=Location), alpha=0.4, size=.25) +
  annotate("segment", x=d_pca[73:74,"PC1"], xend=d_pca[73:74,"PC1"],
           y=0, yend=Inf, col="red", size=.75) + #E_11_06 & E_11_07
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  theme_void() + theme(
...
PC2 <- ggplot(d_pca, aes(x = PC2, y = 0)) +
  geom_density_ridges(aes(color=Location, fill=Location), alpha=0.4, size=.25) +
  annotate("segment", x=d_pca[73:74,"PC2"], xend=d_pca[73:74,"PC2"],
           y=0, yend=Inf, col="red", size=.75) + #E_11_06 & E_11_07
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  theme_void() + theme(
...
PC3 <- ggplot(d_pca, aes(x = PC3, y = 0)) +
  geom_density_ridges(aes(color=Location, fill=Location), alpha=0.4, size=.25) +
  annotate("segment", x=d_pca[73:74,"PC3"], xend=d_pca[73:74,"PC3"],
           y=0, yend=Inf, col="red", size=.75) + #E_11_06 & E_11_07
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  theme_void() + theme(
...
PC4 <- ggplot(d_pca, aes(x = PC4, y = 0)) +
  geom_density_ridges(aes(color=Location, fill=Location), alpha=0.4, size=.25) +
  annotate("segment", x=d_pca[73:74,"PC4"], xend=d_pca[73:74,"PC4"],
           y=0, yend=Inf, col="red", size=.75) + #E_11_06 & E_11_07
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  theme_void() + theme(
...
pdf(here("analysis","figures","Figure_3","Fig3-d.pdf"), width=6, height=3.5)
E_11_06_PCA_2b | PCs
dev.off()
...
pdf(here("analysis","figures","Figure_3","Fig3-e.pdf"), width=3.5, height=3.5)
K_12_28_PCA_1b
dev.off()
...
PC1 <- ggplot(d_pca, aes(x = PC1, y = 0)) +
  ...
  annotate("segment", x=d_pca[79,"PC1"], xend=d_pca[79,"PC1"],
           y=0, yend=Inf, col="red", size=.75) + #K_12_28
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  theme_void() + theme(
    axis.text.x=element_text(size=6), axis.title.x=element_text(size=6),
...
pdf(here("analysis","figures","Figure_3","Fig3-e.pdf"), width=6, height=3.5)
K_12_28_PCA_1b | PCs
dev.off()
...
IAB <- q6 %>% dplyr::select(
  Sample,Location,
  SiO2,TiO2,MgO,CaO,Na2O,Rb,Ba,Th,Nb,Ce,Nd,Sr,Sm,Zr,Yb)
...
K_12_28_PCA_2a <- fviz_pca_biplot(
  ...
  habillage = IAB$Location, fill.ind = IAB$Location,
  pointsize = 2, invisible = "quali", labelsize = 3, repel = T) +
  scale_x_continuous(limits=c(-6, 6)) + scale_y_continuous(limits=c(-3.5, 3)) +
  scale_shape_manual(values=shapes) +
  scale_fill_manual(values=cols) +
  scale_color_manual(values=cols) +
  theme(panel.border = element_rect(colour = "black", fill=NA, size=.5),
...
PC1 <- ggplot(d_pca, aes(x = PC1, y = 0)) +
  geom_density_ridges(aes(color=Location, fill=Location), alpha=0.4, size=.25) +
  annotate("segment", x=d_pca[55,"PC1"], xend=d_pca[55,"PC1"],
           y=0, yend=Inf, col="red", size=.75) + #K_12_28
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  theme_void() + theme(
...
PC2 <- ggplot(d_pca, aes(x = PC2, y = 0)) +
  geom_density_ridges(aes(color=Location, fill=Location), alpha=0.4, size=.25) +
  annotate("segment", x=d_pca[55,"PC2"], xend=d_pca[55,"PC2"],
           y=0, yend=Inf, col="red", size=.75) + #K_12_28
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  theme_void() + theme(
...
PC3 <- ggplot(d_pca, aes(x = PC3, y = 0)) +
  geom_density_ridges(aes(color=Location, fill=Location), alpha=0.4, size=.25) +
  annotate("segment", x=d_pca[55,"PC3"], xend=d_pca[55,"PC3"],
           y=0, yend=Inf, col="red", size=.75) + #K_12_28
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  theme_void() + theme(
...
PC4 <- ggplot(d_pca, aes(x = PC4, y = 0)) +
  geom_density_ridges(aes(color=Location, fill=Location), alpha=0.4, size=.25) +
  annotate("segment", x=d_pca[55,"PC4"], xend=d_pca[55,"PC4"],
           y=0, yend=Inf, col="red", size=.75) + #K_12_28
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  theme_void() + theme(
...
pdf(here("analysis","figures","Figure_3","Fig3-f.pdf"), width=6, height=3.5)
K_12_28_PCA_2b | PCs
dev.off()
...
K_12_29_PCA_1a <- fviz_pca_biplot(
  ...
  habillage = IAB$Location, fill.ind = IAB$Location,
  pointsize = 2, invisible = "quali", labelsize = 3, repel = T) +
  scale_x_continuous(limits=c(-3.5, 3)) + scale_y_continuous(limits=c(-2, 3)) +
  scale_shape_manual(values=shapes) +
  scale_fill_manual(values=cols) +
  scale_color_manual(values=cols) +
  theme(panel.border = element_rect(colour = "black", fill=NA, size=.5),
...
PC1 <- ggplot(d_pca, aes(x = PC1, y = 0)) +
  geom_density_ridges(aes(color=Location, fill=Location), alpha=0.4, size=.25) +
  annotate("segment", x=d_pca[124,"PC1"], xend=d_pca[124,"PC1"],
...
PC2 <- ggplot(d_pca, aes(x = PC2, y = 0)) +
  geom_density_ridges(aes(color=Location, fill=Location), alpha=0.4, size=.25) +
  annotate("segment", x=d_pca[124,"PC2"], xend=d_pca[124,"PC2"],
           y=0, yend=Inf, col="red", size=.75) + #K_12_29
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  theme_void() + theme(
...
PC3 <- ggplot(d_pca, aes(x = PC3, y = 0)) +
  geom_density_ridges(aes(color=Location, fill=Location), alpha=0.4, size=.25) +
  annotate("segment", x=d_pca[124,"PC3"], xend=d_pca[124,"PC3"],
           y=0, yend=Inf, col="red", size=.75) + #K_12_29
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  theme_void() + theme(
...
PC4 <- ggplot(d_pca, aes(x = PC4, y = 0)) +
  geom_density_ridges(aes(color=Location, fill=Location), alpha=0.4, size=.25) +
  annotate("segment", x=d_pca[124,"PC4"], xend=d_pca[124,"PC4"],
           y=0, yend=Inf, col="red", size=.75) + #K_12_29
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  theme_void() + theme(
...
pdf(here("analysis","figures","Figure_3","Fig3-g.pdf"), width=6, height=3.5)
K_12_29_PCA_1b | PCs
dev.off()
...
## K_12_29 PCA2
IAB <- q8 %>% dplyr::select(
  Sample,Location,SiO2,TiO2,MgO,CaO,K2O,Rb,Ba,Th,Nb,Ce,Nd,Sr,Sm,Zr,Yb)
s <- joined_data %>% filter(Sample %in% c("K-12-29")) %>%
  mutate(Location = case_when(grepl("K-12-29", Sample) ~ "K-12-29")) %>%
  dplyr::select(
    Sample,Location,SiO2,TiO2,MgO,CaO,K2O,Rb,Ba,Th,Nb,Ce,Nd,Sr,Sm,Zr,Yb)
...
K_12_29_PCA_2a <- fviz_pca_biplot(
  ...
  habillage = IAB$Location, fill.ind = IAB$Location,
  pointsize = 2, invisible = "quali", labelsize = 3, repel = T) +
  scale_x_continuous(limits=c(-5, 5)) + scale_y_continuous(limits=c(-3.5, 3)) +
  scale_shape_manual(values=shapes) +
  scale_fill_manual(values=cols) +
  scale_color_manual(values=cols) +
  theme(panel.border = element_rect(colour = "black", fill=NA, size=.5),
...
PC1 <- ggplot(d_pca, aes(x = PC1, y = 0)) +
  geom_density_ridges(aes(color=Location, fill=Location), alpha=0.4, size=.25) +
  annotate("segment", x=d_pca[59,"PC1"], xend=d_pca[59,"PC1"],
           y=0, yend=Inf, col="red", size=.75) + #K_12_29
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  theme_void() + theme(
...
PC2 <- ggplot(d_pca, aes(x = PC2, y = 0)) +
  geom_density_ridges(aes(color=Location, fill=Location), alpha=0.4, size=.25) +
  annotate("segment", x=d_pca[59,"PC2"], xend=d_pca[59,"PC2"],
           y=0, yend=Inf, col="red", size=.75) + #K_12_29
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  theme_void() + theme(
...
PC3 <- ggplot(d_pca, aes(x = PC3, y = 0)) +
  geom_density_ridges(aes(color=Location, fill=Location), alpha=0.4, size=.25) +
  annotate("segment", x=d_pca[59,"PC3"], xend=d_pca[59,"PC3"],
           y=0, yend=Inf, col="red", size=.75) + #K_12_29
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  theme_void() + theme(
...
PC4 <- ggplot(d_pca, aes(x = PC4, y = 0)) +
  geom_density_ridges(aes(color=Location, fill=Location), alpha=0.4, size=.25) +
  annotate("segment", x=d_pca[59,"PC4"], xend=d_pca[59,"PC4"],
           y=0, yend=Inf, col="red", size=.75) + #K_12_29
  scale_color_manual(values = cols) + scale_fill_manual(values = cols) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  theme_void() + theme(
